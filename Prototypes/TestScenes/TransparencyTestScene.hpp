...
*                                                                           *
\****************************************************************************/
#ifndef __CFORGE_TRANSPARENCYTESTSCENE_HPP__
#define __CFORGE_TRANSPARENCYTESTSCENE_HPP__
...
namespace CForge {
	...
	class TransparencyTestScene : public ExampleSceneBase {
	public:
		TransparencyTestScene(void) {
			m_WindowTitle = "CrossForge - Transparency Test Scene";
			m_WinWidth = 1280;
			m_WinHeight = 720;
		}//Constructor
